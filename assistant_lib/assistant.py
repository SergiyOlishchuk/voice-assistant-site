...
with open(os.path.join(os.path.dirname(os.path.abspath(__file__)), 'assistant_config.json'), 'r', encoding='UTF-8') as file:
...
def find_video(command, save_audio_path):
    ...
    return answer_to_say + f'<br><a href="{link}">Відео</a>'
